...
class ParserTest extends Specification {
    ...
    def "Array literals with an index return a correct index"() {
        given:
        def input = "[1, 2, 3][0]"
        def expected = new IndexExpression(
                new Token(Tokens.LBRACKET, "["),
                new ArrayLiteral(
                        ...
                        [new IntegerLiteral(new Token(Tokens.INT, "1"), 1),
                         new IntegerLiteral(new Token(Tokens.INT, "2"), 2),
                         new IntegerLiteral(new Token(Tokens.INT, "3"), 3)]
                ),
                new IntegerLiteral(new Token(Tokens.INT, "0"), 0)
        )
    ...
    def "Map literals with an index return a correct index"() {
        given:
        def input = "{ 1: 2 }[1]"
        def expected = new IndexExpression(
                new Token(Tokens.LBRACKET, "["),
                new MapLiteral(
                        new Token(Tokens.LBRACE, "{"),
                        [(new IntegerLiteral(new Token(Tokens.INT, "1"), 1)): new IntegerLiteral(new Token(Tokens.INT, "2"), 2)]
                ),
                new IntegerLiteral(new Token(Tokens.INT, "1"), 1)
        )
